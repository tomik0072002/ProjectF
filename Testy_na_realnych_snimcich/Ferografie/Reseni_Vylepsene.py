...
CANNY_T1       = 0            # dolní práh
CANNY_T2       = 0            # horní práh
CANNY_SIGMA    = 0.33         # citlivost automatického odhadu

# Filtrování částic
MIN_AREA_MM2   = 0.005        # minimální plocha v mm²
...
def analyze_shape(contour: np.ndarray,
    ...
    # Konvexnost: poměr plochy kontury ke ploše konvexního obalu
