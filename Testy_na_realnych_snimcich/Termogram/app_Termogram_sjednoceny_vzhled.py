...
# Zachováno pouze nezbytné CSS pro vlastní indikátory ("Z-bar") - s neutrálními barvami
st.markdown("""
<style>
.zbar-wrap {
...
def z_gauge_html(max_z: float, z_thresh: float, zmap_max: float) -> str:
    ...
    <div class="zbar-wrap">
        ...
        <div class="zbar-track">
            ...
            <div style="position:absolute;top:0;left:{thresh_pct:.1f}%;width:2px;height:100%;background:rgba(255,255,255,0.5);"></div>
            <div style="position:absolute;top:0;left:{thresh2_pct:.1f}%;width:1px;height:100%;background:rgba(255,255,255,0.3);"></div>
            <div style="position:absolute;top:0;left:{thresh4_pct:.1f}%;width:1px;height:100%;background:rgba(255,255,255,0.2);"></div>
        </div>
...
with st.sidebar:
    ...
    # Nastavení detekce
    st.markdown("**Nastavení detekce**")
    z_thresh = st.slider("Z-skóre práh", 1.0, 8.0, 3.2, 0.1, key="sl_z_thresh")
    ...
    st.markdown("---")
    st.markdown("**Velikost buněk na snímku**")
